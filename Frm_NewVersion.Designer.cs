namespace FruitBox
{
	...
	{
		// Token: 0x06000874 RID: 2164 RVA: 0x0018100C File Offset: 0x0017F40C
		...
		// Token: 0x06000875 RID: 2165 RVA: 0x0018105C File Offset: 0x0017F45C
		...
		private void InitializeComponent()
		{
			...
			this.SuspendLayout();
			this.PanelEx3.set_CanvasColor(global::System.Drawing.SystemColors.Control);
			this.PanelEx3.set_ColorSchemeStyle(0);
			...
			this.PanelEx3.set_DisabledBackColor(global::System.Drawing.Color.Empty);
			...
			arg_1C2_0.Size = size;
			this.PanelEx3.get_Style().set_Alignment(global::System.Drawing.StringAlignment.Center);
			this.PanelEx3.get_Style().get_BackColor1().set_Color(global::System.Drawing.Color.White);
			this.PanelEx3.get_Style().get_BackColor2().set_Color(global::System.Drawing.Color.White);
			this.PanelEx3.get_Style().set_Border(2);
			this.PanelEx3.get_Style().get_BorderColor().set_Color(global::System.Drawing.Color.FromArgb(132, 157, 189));
			this.PanelEx3.get_Style().set_BorderWidth(5);
			this.PanelEx3.get_Style().get_ForeColor().set_ColorSchemePart(54);
			this.PanelEx3.get_Style().set_GradientAngle(90);
			this.PanelEx3.TabIndex = 8;
			this.PanelEx3.set_Text("PanelEx3");
			...
			this.txt_show.set_ShowFocusRectangle(false);
			...
			this.UiButton11.set_VisualStyle(7);
			...
			this.UiButton10.set_VisualStyle(7);
